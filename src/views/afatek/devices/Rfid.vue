...
export default {
        ...
        return {
            ...
            table: {
                ...
                fields: [
                    ...
                    {key: 'DeviceMain.CustomerId', label: 'Customer ID'},
    ...
    methods: {
        getDevices(){
            AfatekApi.getDevices(Enums.DEVICETYPE_RFID).then(response => {
        ...
        saveDevice(){
            ...
            AfatekApi.setDevice(Enums.DEVICETYPE_RFID, device).then(response => {
