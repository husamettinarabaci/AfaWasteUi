...
export default {
    data(){
        let deviceTypes = {};
        deviceTypes[Enums.DATATYPE_RECY_MAIN] = 'DeviceMain';
        deviceTypes[Enums.DATATYPE_RECY_BASE] = 'DeviceBase';
        deviceTypes[Enums.DATATYPE_RECY_THERM] = 'DeviceTherm';
        deviceTypes[Enums.DATATYPE_RECY_VERSION] = 'DeviceVersion';
        deviceTypes[Enums.DATATYPE_RECY_ALARM] = 'DeviceAlarm';
        deviceTypes[Enums.DATATYPE_RECY_STATU] = 'DeviceStatu';
        deviceTypes[Enums.DATATYPE_RECY_DETAIL] = 'DeviceDetail';
        deviceTypes[Enums.DATATYPE_ULT_MAIN] = 'DeviceMain';
        deviceTypes[Enums.DATATYPE_ULT_BASE] = 'DeviceBase';
        deviceTypes[Enums.DATATYPE_ULT_BATTERY] = 'DeviceBattery';
        deviceTypes[Enums.DATATYPE_ULT_ALARM] = 'DeviceAlarm';
        deviceTypes[Enums.DATATYPE_ULT_THERM] = 'DeviceTherm';
        deviceTypes[Enums.DATATYPE_ULT_VERSION] = 'DeviceVersion';
        deviceTypes[Enums.DATATYPE_ULT_SENS] = 'DeviceSens';
        deviceTypes[Enums.DATATYPE_RFID_MAIN] = 'DeviceMain';
        deviceTypes[Enums.DATATYPE_RFID_ALARM] = 'DeviceAlarm';
        deviceTypes[Enums.DATATYPE_RFID_THERM] = 'DeviceTherm';
        deviceTypes[Enums.DATATYPE_RFID_VERSION] = 'DeviceVersion';
        deviceTypes[Enums.DATATYPE_RFID_STATU] = 'DeviceStatu';
        deviceTypes[Enums.DATATYPE_RFID_BASE] = 'DeviceBase';
        deviceTypes[Enums.DATATYPE_RFID_DETAIL] = 'DeviceDetail';
        deviceTypes[Enums.DATATYPE_ULT_STATU] = 'DeviceStatu';

        let deviceTypesGps = {};
        deviceTypesGps[Enums.DATATYPE_RECY_GPS] = 'DeviceGps';
        deviceTypesGps[Enums.DATATYPE_ULT_GPS] = 'DeviceGps';
        deviceTypesGps[Enums.DATATYPE_RFID_GPS] = 'DeviceGps';
